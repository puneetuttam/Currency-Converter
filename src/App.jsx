  ...
  return (
    ...
    <div className="w-full h-screen flex justify-center items-center bg-cover bg-no-repeat">
      ...
      <div className="w-full">
        <div className="max-full max-w-fit mx-auto my-10 px-5 py-2 border-none text-3xl rounded-lg flex justify-center bg-blue-600 text-white">Currency Converter</div>
